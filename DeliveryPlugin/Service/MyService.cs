...
namespace Plugin.Service
{
    ...
    public class MyService
    {
        ...
        public EntityCollection FetchXml(string xml)
        {
        ...
        public Entity Retrieve2(string EntityName, object refattribute)
        {
            return service.Retrieve(EntityName, ((EntityReference)refattribute).Id, new ColumnSet(true));
        }
